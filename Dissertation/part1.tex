...
В данной работе будут использоваться физически реализуемые неэмитовые диссипативные операторы, которые активно использующиеся при изучении открытых квантовых систем \cite{Diehl2008, Kraus2008, Bardyn2013, Barreiro2010, Kienzler2014, Vorberg2013}:
